...
public class AccountBotService {
    ...
    public SendPhoto constructAccount(Long chatId, UUID userId) {
        User user = userService.get(userId);

        String text = constructAccountData(chatId, user);
        InlineKeyboardMarkup inlineKeyboardMarkup = constructAccountButtons(chatId, user);
        String path = getImagePath(user);

        return BotUtil.buildSendPhoto(chatId, text, path, inlineKeyboardMarkup);
    }

    private String constructAccountData(Long chatId, User user) {
    ...
    private InlineKeyboardMarkup constructAccountButtons(Long chatId, User user) {
